...
type EveryoneGreetRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EveryoneGreetRequest) Reset() {
	*x = EveryoneGreetRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *EveryoneGreetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EveryoneGreetRequest) ProtoMessage() {}

func (x *EveryoneGreetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EveryoneGreetRequest.ProtoReflect.Descriptor instead.
func (*EveryoneGreetRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{7}
}

func (x *EveryoneGreetRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
type EveryoneGreetResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EveryoneGreetResponse) Reset() {
	*x = EveryoneGreetResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *EveryoneGreetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EveryoneGreetResponse) ProtoMessage() {}

func (x *EveryoneGreetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EveryoneGreetResponse.ProtoReflect.Descriptor instead.
func (*EveryoneGreetResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{8}
}

func (x *EveryoneGreetResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x45, 0x76, 0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71,
	...
	0x67, 0x22, 0x2f, 0x0a, 0x15, 0x45, 0x76, 0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x47, 0x72, 0x65,
	...
	0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x8f, 0x03, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74,
	...
	,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*EveryoneGreetRequest)(nil),         // 7: greet.EveryoneGreetRequest
	(*EveryoneGreetResponse)(nil),        // 8: greet.EveryoneGreetResponse
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0,  // 3: greet.EveryoneGreetRequest.greeting:type_name -> greet.Greeting
	...
	7,  // 8: greet.GreetService.EveryoneGreet:input_type -> greet.EveryoneGreetRequest
	9,  // 9: greet.GreetService.GreetDeadline:input_type -> greet.GreetingWithDeadlineRequest
	...
	8,  // 13: greet.GreetService.EveryoneGreet:output_type -> greet.EveryoneGreetResponse
	10, // 14: greet.GreetService.GreetDeadline:output_type -> greet.GreetingWithDeadlineResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EveryoneGreetRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greet_greetpb_greet_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EveryoneGreetResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetServiceClient interface {
	...
	// Bidirectional
	EveryoneGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_EveryoneGreetClient, error)
	// Unary with Deadline
	GreetDeadline(ctx context.Context, in *GreetingWithDeadlineRequest, opts ...grpc.CallOption) (*GreetingWithDeadlineResponse, error)
}
...
func (c *greetServiceClient) EveryoneGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_EveryoneGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[2], "/greet.GreetService/EveryoneGreet", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceEveryoneGreetClient{stream}
	return x, nil
}

type GreetService_EveryoneGreetClient interface {
	Send(*EveryoneGreetRequest) error
	Recv() (*EveryoneGreetResponse, error)
	grpc.ClientStream
}

type greetServiceEveryoneGreetClient struct {
	grpc.ClientStream
}

func (x *greetServiceEveryoneGreetClient) Send(m *EveryoneGreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceEveryoneGreetClient) Recv() (*EveryoneGreetResponse, error) {
	m := new(EveryoneGreetResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *greetServiceClient) GreetDeadline(ctx context.Context, in *GreetingWithDeadlineRequest, opts ...grpc.CallOption) (*GreetingWithDeadlineResponse, error) {
...
type GreetServiceServer interface {
	...
	// Bidirectional
	EveryoneGreet(GreetService_EveryoneGreetServer) error
	// Unary with Deadline
	GreetDeadline(context.Context, *GreetingWithDeadlineRequest) (*GreetingWithDeadlineResponse, error)
}
...
func (*UnimplementedGreetServiceServer) EveryoneGreet(GreetService_EveryoneGreetServer) error {
	return status.Errorf(codes.Unimplemented, "method EveryoneGreet not implemented")
}
func (*UnimplementedGreetServiceServer) GreetDeadline(context.Context, *GreetingWithDeadlineRequest) (*GreetingWithDeadlineResponse, error) {
...
func _GreetService_EveryoneGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).EveryoneGreet(&greetServiceEveryoneGreetServer{stream})
}

type GreetService_EveryoneGreetServer interface {
	Send(*EveryoneGreetResponse) error
	Recv() (*EveryoneGreetRequest, error)
	grpc.ServerStream
}

type greetServiceEveryoneGreetServer struct {
	grpc.ServerStream
}

func (x *greetServiceEveryoneGreetServer) Send(m *EveryoneGreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceEveryoneGreetServer) Recv() (*EveryoneGreetRequest, error) {
	m := new(EveryoneGreetRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _GreetService_GreetDeadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetDeadline(ctx, req.(*GreetingWithDeadlineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "EveryoneGreet",
			Handler:       _GreetService_EveryoneGreet_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
